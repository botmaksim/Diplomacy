...
set CLASSPATH=%APP_HOME%\lib\desktop-1.0.0.jar;%APP_HOME%\lib\javafx-fxml-21-win.jar;%APP_HOME%\lib\javafx-controls-21-win.jar;%APP_HOME%\lib\javafx-controls-21.jar;%APP_HOME%\lib\javafx-graphics-21-win.jar;%APP_HOME%\lib\javafx-graphics-21.jar;%APP_HOME%\lib\javafx-base-21-win.jar;%APP_HOME%\lib\javafx-base-21.jar;%APP_HOME%\lib\core-1.0.0.jar;%APP_HOME%\lib\fxsvgimage-1.1.jar;%APP_HOME%\lib\gson-2.10.1.jar
